# Series Tổng hợp các câu hỏi phỏng vấn Phần 5: Data Engineer (phần 9)

Nguồn: https://www.threads.com/@3dongcode/post/DVWE2_CEyWu

Sự khác biệt giữa dữ liệu có cấu trúc (structured data) và dữ liệu không có cấu trúc (unstructured data) là gì?
