# Series Tổng hợp các câu hỏi phỏng vấn Phần 5: Data Engineer (phần 2)

Nguồn: https://www.threads.com/@3dongcode/post/DUijIVCEoHJ

Bạn sẽ sử dụng thư viện Python nào để xử lý dữ liệu hiệu quả?
