---
title: 'Trong Python *args và **kwargs được dùng để làm gì?'
description: 'Câu hỏi phỏng vấn Data Engineer: Trong Python *args và **kwargs được dùng để làm gì?'
questionNumber: 41
...
sourceUrl: 'https://www.threads.com/@3dongcode/post/DXJ5cu_FChu'
draft: true
---
